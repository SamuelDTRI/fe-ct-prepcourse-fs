...
function empiezaConNueve(num) {
   ...
   // Tu código:
   var fox = num.toString().split('');
   var fox2 = fox.filter(i=> i[0] === '9')
...
function mayorACien(array) {
   ...
   for (let i=0; i< array.length; i++)
   {
       if(array[i]>100) {num.push(array[i])}   
   }
   return num;
